...
var app = (function () {
    ...
    /* node_modules/svelte-frappe-charts/src/components/base.svelte generated by Svelte v3.49.0 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div4 = element("div");
    			div0 = element("div");
    			div0.textContent = "Windmesser";
    			t1 = space();
    			div3 = element("div");
    			div1 = element("div");
    			t2 = text(/*lastUpdated*/ ctx[0]);
    			t3 = space();
    			div2 = element("div");
    			div2.textContent = "↻";
    			t5 = space();
    			div6 = element("div");
    			div5 = element("div");
    			div5.textContent = "12h Verlauf [m/s]";
    			t7 = space();
    			create_component(chart.$$.fragment);
    			attr_dev(div0, "class", "header-title svelte-1v25npm");
    			add_location(div0, file, 124, 3, 2682);
    			attr_dev(div1, "class", "update-text svelte-1v25npm");
    			add_location(div1, file, 126, 4, 2753);
    			attr_dev(div2, "class", "update-spinner svelte-1v25npm");
    			toggle_class(div2, "loadingAnimation", /*isUpdating*/ ctx[2]);
    			add_location(div2, file, 127, 4, 2804);
    			attr_dev(div3, "class", "update svelte-1v25npm");
    			add_location(div3, file, 125, 3, 2728);
    			attr_dev(div4, "class", "header svelte-1v25npm");
    			add_location(div4, file, 123, 2, 2658);
    			attr_dev(div5, "class", "box-title svelte-1v25npm");
    			add_location(div5, file, 132, 3, 2940);
    			attr_dev(div6, "class", "box svelte-1v25npm");
    			add_location(div6, file, 131, 2, 2919);
    			attr_dev(div7, "id", "content");
    			attr_dev(div7, "class", "svelte-1v25npm");
    			add_location(div7, file, 121, 1, 2636);
    			attr_dev(div8, "id", "container");
    			attr_dev(div8, "class", "svelte-1v25npm");
    			add_location(div8, file, 120, 0, 2614);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div6, t7);
    			mount_component(chart, div6, null);
    			current = true;

    			if (!mounted) {
    				dispose = listen_dev(div2, "click", /*fetchData*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*lastUpdated*/ 1) set_data_dev(t2, /*lastUpdated*/ ctx[0]);

    			if (dirty & /*isUpdating*/ 4) {
    				toggle_class(div2, "loadingAnimation", /*isUpdating*/ ctx[2]);
    			}

    			const chart_changes = {};
    			if (dirty & /*dataLastDay*/ 2) chart_changes.data = /*dataLastDay*/ ctx[1];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let textLabels = ["", "", "", "", "", "", "", "", "", "", "", ""];
    	let lastUpdated = "lädt...";

    	let dataLastDay = {
    		labels: textLabels,
    		datasets: [{ name: "Dach", values: values[0] }, { name: "Schuppen", values: values[1] }]
    	};
    ...
    */
    	const getCurrentDate = () => {
    		...
    		return d.getDate() + "." + d.getMonth() + "." + d.getFullYear() + " - " + (d.getHours() < 10 ? '0' : '') + d.getHours() + ":" + (d.getMinutes() < 10 ? '0' : '') + d.getMinutes();
    	};
    	...
    	const generateTimeLabelArray = lastTimestamp => {
    		let timeLabelArray = [];

    		for (let i = 11; i >= 0; i--) {
    			timeLabelArray[i] = convertTimestampToHour(lastTimestamp - 3600 * (11 - i));
    		}
    	...
    	const updateChart = data => {
    		...
    		data.slice().reverse().forEach(point => {
    			if (typeof point[1] === "number") {
    				let sensorIndex = point[1];

    				if (count[sensorIndex] >= 0) {
    					values[sensorIndex][count[sensorIndex]] = point[2];
    					count[sensorIndex]--;
    				}
    			}
    		});

    		let lastTimestamp = data[23][0];
    		textLabels = generateTimeLabelArray(lastTimestamp);

    		$$invalidate(1, dataLastDay = {
    			labels: textLabels,
    			datasets: [
    				{ name: "Dach", values: values[0] },
    				{ name: "Schuppen", values: values[1] }
    			]
    		});

    		$$invalidate(0, lastUpdated = getCurrentDate());
    	};
    	...
    	const fetchData = () => {
    		if (!isUpdating) {
    			$$invalidate(2, isUpdating = true);
    			$$invalidate(0, lastUpdated = "lädt...");

    			fetch("https://script.google.com/macros/s/AKfycbxN6fqU_coS7SuQr6JbVYZdQevzMZkn-8Urg4_pSMm9fqPkIT5WUtr3tlA-Z3wjj2SVqg/exec").then(response => response.json()).then(data => {
    				console.log(data);
    				updateChart(data);
    				$$invalidate(2, isUpdating = false);
    			});
    		}
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('textLabels' in $$props) textLabels = $$props.textLabels;
    		if ('lastUpdated' in $$props) $$invalidate(0, lastUpdated = $$props.lastUpdated);
    		if ('dataLastDay' in $$props) $$invalidate(1, dataLastDay = $$props.dataLastDay);
    		if ('isUpdating' in $$props) $$invalidate(2, isUpdating = $$props.isUpdating);
    	};
    	...
    	return [lastUpdated, dataLastDay, isUpdating, fetchData];
    }
